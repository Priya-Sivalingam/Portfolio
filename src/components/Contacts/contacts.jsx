            ...
            <div className='contact_content'>
                ...
                <div className='contact_info'>
                    <div className='contact_card'>
                        ...
                        <a href='mailto:manimohan517@gmail.com' className='contact_button'>Click</a>
                    </div>
                    ...
                    <div className='contact_card'>
                        ...
                        <a href='https://www.linkedin.com/in/tmanimohan' className='contact_button'>Click</a>
                    </div>
                    ...
                    <div className='contact_card'>
                        ...
                        <a href='https://api.whatsapp.com/send?phone=94771781833&text=Hello, more information!' className='contact_button'>Click</a>
                    </div>
                </div>
            </div>
            ...
            <div className='contact_content'>
                ...
                <form className='contact_form'>
                    <div className='contact_form-div'>
                        ...
                        className='contact_form-input' placeholder='Insert Your Name '></input>
                    </div>

                    <div className='contact_form-div'>
                        <label className='contact_form-tag'>Mail </label>
                        <input type='email' name='email'
                        className='contact_form-input' placeholder='Insert Your email address '></input>
                    </div>

                    
                    <div className='contact_form-div contact_form-area'>
                        <label className='contact_form-tag '>Message </label>
                        <textarea name='message' cols={30} rows={10} className='contact_form-input' placeholder='Message'></textarea>
                    </div>
